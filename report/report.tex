...
\begin{table}
	\centering
	\caption{Pivoting, Gibbs shifts beacause its narrow}
	\label{dlkasd}
...
%	\csvautotabular[respect sharp]{img/out/T3_9/MH/csv/2_reel_skills.csv} %
%	\csvautotabular[respect sharp]{img/out/T3_9/MH/csv/3_skills.csv} \\[5mm]
...
\begin{table}
	...
	%	\csvautotabular[respect sharp]{img/out/T4_11/Gibbs/csv/2_reel_skills.csv} %
	%	\csvautotabular[respect sharp]{img/out/T4_11/Gibbs/csv/3_skills.csv} \\[5mm]
